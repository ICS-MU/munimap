...
goog.provide('ics.map.source.Cluster');
 ...
 * @api
 */
ics.map.source.Cluster = function(options) {
  goog.base(this, {
 ...
 * @api
 */
ics.map.source.Cluster.prototype.getSource = function() {
  return this.source_;
};
 ...
 * @inheritDoc
 */
ics.map.source.Cluster.prototype.loadFeatures = function(extent, resolution,
    projection) {
 ...
 * @private
 */
ics.map.source.Cluster.prototype.onSourceChange_ = function() {
  this.clear();
  this.cluster_();
  this.addFeatures(this.features_);
  this.changed();
 ...
 * @private
 */
ics.map.source.Cluster.prototype.cluster_ = function() {
 ...
 * @private
 */
ics.map.source.Cluster.prototype.createCluster_ = function(features) {
