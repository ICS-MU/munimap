...
BEGIN
	...
	ALTER INDEX ALL ON dbo.BODY_ZAJMU REBUILD;
	ALTER INDEX ALL ON dbo.BUDOVY REBUILD;
	ALTER INDEX ALL ON dbo.DVERE REBUILD;
	ALTER INDEX ALL ON dbo.MISTNOSTI REBUILD;
